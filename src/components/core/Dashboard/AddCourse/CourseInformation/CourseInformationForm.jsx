...
export default function CourseInformationForm() {
  ...
  return (
    <form
      ...
      className="space-y-8 rounded-md border-[1px] border-black bg-richblack-800 p-6"
    >
      {/* Course Title */}
...
<div className="flex flex-col space-y-2">
  ...
  {errors.courseCategory && (
    <span className="ml-2 text-xs tracking-wide text-black">
      ...
      <div className="flex justify-end gap-x-2">
        {editCourse && (
          <button
            ...
            disabled={loading}
            className={`flex cursor-pointer items-center gap-x-2 rounded-md bg-mwhite py-[8px] px-[20px] font-semibold text-black`}
          >
