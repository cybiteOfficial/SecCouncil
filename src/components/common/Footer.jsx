...
const Footer = () => {
  return (
    ...
    style={{ boxShadow: "0px -4px 15px rgba(255, 165, 0, 0.5)" }}>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-11/12 max-w-maxContent text-black mx-auto pb-14 text-sm">
              ...
              <div
                ...
                className={`${
                  BottomFooter.length - 1 === i
                    ? ""
                    : "border-r border-black cursor-pointer hover:text-black transition-all duration-200"
                } px-3`}
              >
