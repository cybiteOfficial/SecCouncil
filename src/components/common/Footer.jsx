...
const Footer = () => {
  return (
    ...
    style={{  boxShadow: "0px -4px 15px rgba(0, 74, 173, 0.5)" }}>
              ...
              <div className="flex gap-3 mt-4 text-lg">
                {[
                  ...
                  <a
                    ...
                    className="social-icon transition duration-300 hover:opacity-75 hover:bg-mwhite"
                  >
                    {icon}
                  </a>
                ))}
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-11/12 max-w-maxContent text-mwhite mx-auto pb-14 text-sm">
              ...
              <div
                ...
                className={`${
                  BottomFooter.length - 1 === i
                    ? ""
                    : "border-r border-mwhite cursor-pointer hover:text-yellow-800 transition-all duration-200"
                } px-3`}
              >
